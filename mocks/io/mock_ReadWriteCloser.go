...
func (_c *MockReadWriteCloser_Close_Call) Return(_a0 error) *MockReadWriteCloser_Close_Call {
	_c.Call.Return(_a0)
	return _c
}
...
func (_m *MockReadWriteCloser) Read(p []byte) (int, error) {
	ret := _m.Called(p)
...
func (_c *MockReadWriteCloser_Read_Call) RunAndReturn(run func([]byte) (int, error)) *MockReadWriteCloser_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Write provides a mock function with given fields: p
func (_m *MockReadWriteCloser) Write(p []byte) (int, error) {
	ret := _m.Called(p)
...
func (_c *MockReadWriteCloser_Write_Call) RunAndReturn(run func([]byte) (int, error)) *MockReadWriteCloser_Write_Call {
	_c.Call.Return(run)
	return _c
}
